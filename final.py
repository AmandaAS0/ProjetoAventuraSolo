...
def final_maga():
    ...
    while condicao:
        ...
        if final.upper() == "1":
            ...
            print("\n\nEssa aventura encerra por aqui...")
            condicao = False
...
def final_ladino():
    ...
    while condicao:
        ...
        if final.upper() == "1":
            time.sleep(1)
            print("Você não precisa e não quer voltar pra casa, e menos ainda pra guilda já que agora certamente você terá que fazer parte dela devido a tudo que você sabe. Sua melhor opção é destruir a flor e fugir para muito longe, onde ninguém possa encontrá-lo..")
            print("\n\nEssa aventura encerra por aqui...")
            condicao = False
            ...
            time.sleep(2)
            print("\n\nVocê leva a flor de volta pra guilda, a maldição do item que seu pai carrega e desfeita e você percebe que não consegue mais olhar ele nos olhos. Você não confia mais nele. O melhor a fazer é partir pra outro lugar e tentar construir outra vida")
            print("\n\nEssa aventura encerra por aqui...") 
            condicao = False
            break
        else:
